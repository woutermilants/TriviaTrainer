package be.milants.triviatrainer.helper;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DICTIONARY_TABLE_CREATE =
            "CREATE TABLE " + MAIN_CATEGORY_TABLE + " (" + MAIN_CATEGORY_TABLE_NAME + " TEXT primary key)";
    //The Android's default system path of your application database.
    private static String DB_PATH = "/data/data/be.milants.triviatrainer/databases/";
